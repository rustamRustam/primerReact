...
type CollectionKartochekState = {
  count: number;
};

class CollectionKartochek extends Component<CollectionKartochekProps, CollectionKartochekState> {
  state: CollectionKartochekState = {
    count: 0
  };

  constructor(props:CollectionKartochekProps) {
    super(props);
